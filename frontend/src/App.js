...
function App(props) {
  ...
  let showbar = () => {
    if (upbar === "watchlist-close") setupbar("watchlist-open");
  };
  let closebar = () => {
    if (upbar === "watchlist-open") setupbar("watchlist-close");
  };
        ...
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={
                <PublicRoute>
                  <Signup theme={theme} changetheme={changetheme} />
                </PublicRoute>
              }
            />
                      ...
                      <WatchlistProvider>
                        ...
                        <Routes>
                          <Route
                            path="/Diff"
                            element={
                              <Diff theme={theme} changetheme={changetheme} />
                            }
                          />
                          <Route
                            path="/contact"
                          ...
                          <Route
                            path="/home2"
                            element={
                              <Home2 theme={theme} changetheme={changetheme} />
                            }
                          />
                          <Route
                          ...
                          <Route
                            path="/videos"
                            element={
                              <Videos theme={theme} changetheme={changetheme} />
                            }
                          />
                          <Route
                            path="/discription"
